<?php
  ...
  $checkEmail = mysql_query("SELECT Email FROM Survey_Accounts WHERE Email = '$email'");
   ...
   if (mysql_num_rows($checkEmail) > 0) {
    ...
    $message = "<html><body>";
    $message .= "Greetings from Class Tempo! \n To reset your password simply click the following link: http://www.classtempo.org/Survey_app/survey_phpScripts/resetPassword.php?email=". $email . "&resetKey=" . $resetHash . " \n If the link's broken, please paste it into your browser!";
